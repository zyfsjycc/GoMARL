...
class Academy_Counterattack_Easy(MultiAgentEnv):
    ...
    def get_simple_obs(self, index=-1):
        ...
        if index == -1:
            ...
            simple_obs.append(full_obs['right_team'][3])
            simple_obs.append(full_obs['right_team_direction'][0])
            simple_obs.append(full_obs['right_team_direction'][3])
            ...
            simple_obs.append(full_obs['right_team'][3] - ego_position)
            simple_obs.append(full_obs['right_team_direction'][0])
            simple_obs.append(full_obs['right_team_direction'][3])
